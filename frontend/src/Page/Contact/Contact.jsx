      ...
      <div className='container mx-auto px-4 max-w-6xl'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            태양광 설비 설치부터 유지보수까지, 전문가와 상담하세요. 24시간 내에 답변해드리겠습니다.
          </p>
        </div>
          ...
          <div>
            <form className='bg-white rounded-2xl shadow-xl p-8'>
              <div className='space-y-6'>
                ...
                <div>
                  <label className='block text-gray-700 font-medium mb-2'>이메일일</label>
                  <input
                    type='email'
                    className='w-full p-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-colors duration-300'
                ...
                <div>
                  <label className='block text-gray-700 font-medium mb-2'>전화번호호</label>
                  <input
                    type='tel'
                    className='w-full p-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-colors duration-300'
                ...
                <div>
                  <label className='block text-gray-700 font-medium mb-2'>문의내용용</label>
                  <textarea
